...
jakalib::optional<char> readNextChar() {
  return {};
}

void run(jakalib::optional<std::string>) {}
...
bool fun(std::string, jakalib::optional<int> oi = jakalib::nullopt) {
  return bool(oi);
}
...
static_assert(
    std::is_base_of<std::logic_error, jakalib::bad_optional_access>::value, "");
